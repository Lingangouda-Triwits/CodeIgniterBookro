  ...
  <div class="card" >
    ...
    <?php if (!empty($message)) : ?>
      ...
      <form action="<?php echo base_url()?>index.php/users/driver/DRegContro/insertData" method="post" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
          <input type="phone" class="form-control" name="mobile" placeholder="Mobile Number" minlength="10" maxlength="10" pattern="^[6-9][0-9]*$" required oninput="if(!this.value.match('^[6-9][0-9]*$'))this.value='';" style="background-color: #e3f2fd;">
          <div class="input-group-append">
            <div class="input-group-text">

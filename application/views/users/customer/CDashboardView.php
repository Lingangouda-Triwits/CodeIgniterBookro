...
<!-- <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php
      //  echo base_url().'index.php/users/customer/CDashboardCont/saveRequest';
       ?>" method="POST">
...
<!-- <div class="d-flex justify-content-center mt-5">
  <button class="edit btn btn-lg btn-primary" data-bs-toggle="modal" data-bs-target="#editModal">Ride</button>
</div> -->
...
<div class="content-wrapper">
  ...
  <!-- <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col">
          <h1 class="m-0 text-white">Book a Ride here</h1>
        </div>
      </div>
    </div>
  </div> -->

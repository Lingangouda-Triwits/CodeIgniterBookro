  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Ongoing Rides</h1>
            </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        </div>
        ...
        <div class="container">
            ...
            <?php 
              $slno = 0;
              foreach ($ongoingRides as $onRides) {
                $slno = $slno + 1;
                ...
                echo "<tr>
                        ...
                        <td>". $onRides->name . "</td>
                        <td>". $onRides->email . "</td>
                        <td>". $onRides->mobile . "</td>
                        <td>". $onRides->boarding . "</td>
                        <td>". $onRides->destination . "</td>
                        <td>". $onRides->totalPeople . "</td>
                        <td>". $onRides->demail . "</td>
                        <td>". $onRides->acceptedOn . "</td>
                      </tr>";
              }
            ?>
